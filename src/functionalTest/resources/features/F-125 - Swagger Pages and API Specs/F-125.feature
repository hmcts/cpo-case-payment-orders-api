...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: must show Swagger UI page APIs
    ...
    And it is submitted to call the [Get Swagger UI Page] operation of [CPO Case Payment Orders],
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: must show Swagger Json APIs
    ...
    When a request is prepared with appropriate values,
    And it is submitted to call the [Get Swagger Json API] operation of [CPO Case Payment Orders],
